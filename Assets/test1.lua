...
mat1 = gr.material({0.7, 1.0, 0.7}, {0.5, 0.7, 0.5}, 25, 0.95)
...
s2 = gr.nh_sphere('s2', {200, 50, -100}, 50)
-- scene_root:add_child(s2)
s2:set_material(mat1)

--s3 = gr.nh_sphere('s3', {-100, -100, 100}, 200)
s3 = gr.sphere('s3')
s3:scale(150, 150, 50)
s3:translate(-50, 0, 300)
scene_root:add_child(s3)
s3:set_material(mat1)

b1 = gr.nh_box('b1', {-100, -100, 100}, 100)
...
gr.render(scene_root, 'ref.png', 512, 512,
